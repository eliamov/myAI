  ...
  return (
    ...
    >
      <motion.div
        ...
        className="px-3 py-1 bg-white dark:bg-gray-700 dark:text-white rounded-2xl max-w-[60%] shadow-md hover:shadow-lg transition-shadow duration-300"
      >
        {message.content}
      </motion.div>
    </motion.div>
  ...
  return (
    ...
    >
      ...
      <motion.div
        whileHover={{ scale: 1.01 }}
        transition={{ type: "spring", stiffness: 300, damping: 20 }}
        className="px-3 py-1 bg-white dark:bg-gray-800 dark:text-white rounded-2xl max-w-[60%] shadow-md hover:shadow-lg transition-shadow duration-300"
      >
...
function EmptyMessages() {
  return (
    <div className="flex flex-col flex-1 p-1 gap-3 justify-center items-center">
      <p className="text-gray-500 dark:text-gray-300">Ask a question to start the conversation</p>
    </div>
  );
}
